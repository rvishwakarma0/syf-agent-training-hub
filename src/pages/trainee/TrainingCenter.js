    ...
    const fetchScenarios = async () => {
      try {
        ...
        const formatted = data.map(item => ({
          ...
          color: pickCategoryColor(item.tags?.[0])
        }));

        setTpodList(formatted);

        const uniqueCats = [...new Set(formatted.map(item => item.category))];
      ...
      >
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Typography variant="subtitle1" color="text.secondary" sx={{ fontSize: '1rem' }}>
            Choose a Training POD to start your journey towards mastering customer interactions.
          </Typography>
        </Box>
                    ...
                    >
                      ...
                      <CardContent sx={{ flexGrow: 1, p: 3 }}>
                        ...
                        <Box sx={{ display: 'flex', gap: 1, mb: 3 }}>
                          ...
                          />
                          <Chip label={scenario.duration} size="small" variant="outlined" />
                        </Box>
